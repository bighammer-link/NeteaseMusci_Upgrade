...
## 🍷🍷注意：由于网易云音乐使用手机号和邮箱登录增加了云盾验证，目前还无法绕过验证，故此项目采用的是<b>扫码登录</b>的方式，同时也能防止你的密码泄露
## ⛔使用须知⛔
...
3.因为每天要更换歌单id,并且目前账号密码登录的方式不可用，所以每天在更换歌单id的时候要重新运行main.py进行扫码登录
<br/>
## 代码参数解释  
<br/>
这是运行该项目所需要的配置参数
...
<br/>
 ...
 3.在本地电脑部署，比较简单<br/>
 下面是我在本地和青龙面板上成功运行样图
 <img decoding="async" src="img/bendi.png" width="75%">
 <img decoding="async" src="img/qinglong.png" width="75%">
